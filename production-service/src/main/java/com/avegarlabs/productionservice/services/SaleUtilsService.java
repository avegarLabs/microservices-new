...
import com.avegarlabs.productionservice.dto.SaleListItem;
...
public class SaleUtilsService {
    ...
    public List<SaleListItem> getSalesList(){
        ...
        SaleListItem[] saleListItems = webClientBuilder.build()
                .get()
                .uri("http://localhost:8083/api/sale/month")
    ...
    @Cacheable(value = "allSales", unless = "#result == null")
    public List<SaleListItem> getAllSalesList(){
        ...
        SaleListItem[] saleListItems = webClientBuilder.build()
                .get()
                .uri("http://localhost:8083/api/sale")
                .header("Authorization", "Bearer " + token)
                .retrieve()
                .bodyToMono(SaleListItem[].class)
                .block();
